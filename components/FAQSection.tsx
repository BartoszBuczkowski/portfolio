    ...
    <section className="bg-muted/35 py-12">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-6 px-6">
        <div className="flex flex-col gap-4">
          <h2 className="text-[36px] leading-[44px] tracking-[-0.02em] font-extrabold text-foreground">Frequently Asked Questions</h2>
          <p className="max-w-xl text-base leading-6 text-muted-foreground">
            Can&apos;t able to find answers you&apos;re looking for?
            <br />
            Reach out to our{" "}
            <a href="#" className="text-accent-violet transition-colors hover:text-accent-blue">
              customer support
            </a>{" "}
            team.
          </p>
